                    ...
                    <div className="relative w-full max-w-2xl rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-900">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <select name="type" value={formData.type} onChange={handleChange}
                                    className="w-full border rounded p-2">
                                <option value="atelier1" className="bg-red-brou">Atelier vocal 1</option>
                                <option value="atelier2" className="bg-green-500">Atelier vocal 2</option>
                            </select>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative w-full max-w-2xl rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-900">
                        ...
                        <p className={selectedRehearsal.type == "atelier1" ? 'text-red-brou' : 'text-green-500'}>
                            <strong>Atelier :</strong> {selectedRehearsal.type}</p>
