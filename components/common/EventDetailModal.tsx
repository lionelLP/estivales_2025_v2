...
export function EventDetailModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white dark:bg-neutral-900 rounded-lg max-w-3xl w-full p-6 relative my-8">
        <div className="flex flex-col items-center relative max-h-[80vh] overflow-y-auto">
          ...
          {/* Reste du contenu */}
          {event.description && (
            <p className="mt-6 text-neutral-900 dark:text-gray-200 whitespace-pre-wrap text-center">
              {event.description}
            </p>
          )}
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-500 hover:text-gray-700 dark:bg-white bg-gray-300 rounded-full w-8 h-8 flex items-center justify-center hover:bg-gray-100 transition-colors"
        >
          ✕
        </button>
      </div>
